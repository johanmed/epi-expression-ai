...
plot_go <- function(go, ont_type){
    # Draw barplot of results
    print(barplot(go))
    dev.copy(pdf, glue("results/barplot_kegg_{ont_type}_results.pdf"), width=15, height=10)
    dev.off()
    # Draw dotplot of results
    print(dotplot(go))
    dev.copy(pdf, glue("results/dotplot_kegg_{ont_type}_results.pdf"), width=15, height=10)
    dev.off()
}
