...
write.table(trans_methyl_pheno, "~/methylation_phenofile.txt", row.names=FALSE, col.names=FALSE, sep=", ", quote=FALSE) # without strains

write.table(trans_methyl_pheno, "~/methylation_phenofile_strains.csv", row.names=TRUE, col.names=TRUE, sep=", ", quote=FALSE) # with strains and phenotypes


# Save only methylation phenotypes for DMPs

inter_methyl_pheno <- beta[match(rownames(beta), rownames(final_dmps)),]
...
write.table(tinter_methyl_pheno, file="~/interest_methylation_phenofile.csv", row.names=FALSE, col.names=FALSE, sep=", ", quote=FALSE) # without strains

write.table(tinter_methyl_pheno, file="~/interest_methylation_phenofile_strains.csv", row.names=TRUE, col.names=TRUE, sep=", ", quote=FALSE) # with strains and phenotypes
