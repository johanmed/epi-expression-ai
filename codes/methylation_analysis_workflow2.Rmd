...
write.csv(tinter_methyl_pheno, "~/interest_methylation_phenofile.csv", row.names=FALSE) # without strains

write.csv(tinter_methyl_pheno, "~/interest_methylation_phenofile_strains.csv", row.names=TRUE) # with strains
